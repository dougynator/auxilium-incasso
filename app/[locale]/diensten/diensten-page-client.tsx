...
export default function DienstenPageClient({ messages }: { messages: Messages }) {
  const incassoServices = [
    {
      icon: FileText,
      title: messages.services.easySubmission.title,
      description: messages.services.easySubmission.description,
      color: "bg-primary/10 text-primary border-primary/20",
    },
    {
      icon: Search,
      title: messages.services.autoCheck.title,
      description: messages.services.autoCheck.description,
      color: "bg-green-50 text-green-700 border-green-200",
    },
    {
      icon: MessageSquare,
      title: messages.services.professionalContact.title,
      description: messages.services.professionalContact.description,
      color: "bg-orange-50 text-orange-700 border-orange-200",
    },
    {
      icon: CreditCard,
      title: messages.services.noCureNoPay.title,
      description: messages.services.noCureNoPay.description,
      color: "bg-purple-50 text-purple-700 border-purple-200",
    },
    {
      icon: Clock,
      title: messages.services.fastTreatment.title,
      description: messages.services.fastTreatment.description,
      color: "bg-blue-50 text-blue-700 border-blue-200",
    },
    {
      icon: Shield,
      title: messages.services.allAmounts.title,
      description: messages.services.allAmounts.description,
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <span className="relative flex items-center gap-3 z-10">
                        <span className="font-bold">{messages.common.submitNow}</span>
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="text-center mb-12">
                <h2 className="font-display text-3xl md:text-4xl font-bold text-primary mb-4">
                  {messages.services.debtorManagement.title}
                </h2>
                  ...
                  <div className="space-y-6">
                    <div>
                      <h3 className="font-display text-2xl md:text-3xl font-bold text-foreground mb-4">
                        {messages.services.debtorManagement.subtitle}
                      </h3>
                      <p className="font-sans text-base md:text-lg text-muted-foreground leading-relaxed">
                        {messages.services.debtorManagement.description}
                      </p>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <p className="font-sans text-sm md:text-base text-muted-foreground">
                          {messages.services.debtorManagement.autoFollowup}
                        </p>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <p className="font-sans text-sm md:text-base text-muted-foreground">
                          {messages.services.debtorManagement.proactiveMonitoring}
                        </p>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <p className="font-sans text-sm md:text-base text-muted-foreground">
                          {messages.services.debtorManagement.noWorries}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="pt-6">
                      <Link href="/contact">
                        <Button className="bg-primary hover:bg-primary/90 text-white px-6 py-3 font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg">
                          {messages.services.debtorManagement.contactUs}
                        </Button>
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-white rounded-xl p-6 border-2 border-primary/20">
                      ...
                      <div className="mb-4 pb-3 border-b border-primary/20">
                        <h4 className="font-display font-semibold text-sm text-foreground">{messages.services.debtorManagement.outstandingInvoices}</h4>
                        <p className="font-sans text-xs text-muted-foreground">{messages.services.debtorManagement.customer}: ABC Bedrijf BV</p>
                      </div>
                        ...
                        <div className="bg-white rounded-lg p-3 shadow-sm border-l-4 border-orange-400">
                          <div className="flex items-start justify-between gap-2 mb-2">
                            ...
                            <div className="px-2 py-1 bg-orange-100 rounded text-xs font-semibold text-orange-700">
                              {messages.services.debtorManagement.inProgress}
                            </div>
                          </div>
                        ...
                        <div className="bg-white rounded-lg p-3 shadow-sm border-l-4 border-green-400 opacity-75">
                          <div className="flex items-start justify-between gap-2 mb-2">
                            ...
                            <div className="px-2 py-1 bg-green-100 rounded text-xs font-semibold text-green-700">
                              {messages.services.debtorManagement.paid}
                            </div>
                          </div>
                          <div className="flex items-center gap-2 mt-2">
                      ...
                      <div className="mt-4 pt-4 border-t border-primary/20">
                        <div className="flex items-center gap-2">
                          ...
                          <p className="font-sans text-xs text-muted-foreground">
                            {messages.services.debtorManagement.systemMonitors}
                          </p>
                        </div>
                      </div>
                    </div>
